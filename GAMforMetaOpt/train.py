...
if __name__ == '__main__':
    ...
    #lambda_epoch = lambda e: 1.0 if e < 2 else (0.06 if e < 8 else 0.012 if e < 10 else (0.012))
    lambda_epoch = lambda e: 1.0 if e < 10 else (0.06 if e < 20 else 0.012 if e < 25 else (0.012))
