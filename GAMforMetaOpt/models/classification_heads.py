...
from qpth_nonsmooth.qp_new import QPFunction
...
def MetaOptNetHead_SVM_CS_1(query, support, support_labels, n_way, n_shot, C_reg=0.1, double_precision=False, maxIter=3):
    """
    Fits the support set with multi-class SVM and 
    returns the classification score on the query set.
